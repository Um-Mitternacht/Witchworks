...
import com.witchworks.api.item.Constants;
...
public class ItemTaglock extends ItemMod {
	...
	public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
		if (NBTHelper.hasTag(stack, Constants.TAGLOCK_ENTITY_NAME)) {
			tooltip.add(NBTHelper.getString(stack, Constants.TAGLOCK_ENTITY_NAME));
		} else {
	...
	public void setVictim(ItemStack stack, EntityLivingBase victim) {
		NBTHelper.setUniqueID(stack, Constants.TAGLOCK_ENTITY, victim.getUniqueID());
		NBTHelper.setString(stack, Constants.TAGLOCK_ENTITY_NAME, victim.getName());
	}

	public Optional<EntityLivingBase> getVictim(ItemStack stack, World world) {
		UUID uuid = NBTHelper.getUniqueID(stack, Constants.TAGLOCK_ENTITY);
