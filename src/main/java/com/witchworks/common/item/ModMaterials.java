...
public final class ModMaterials {
	...
	public static final ItemArmor.ArmorMaterial ARMOR_COLD_IRON = EnumHelper.addArmorMaterial(LibItemName.COLD_IRON, LibMod.MOD_ID + ":" + LibItemName.SILVER, 18, new int[]{2, 9, 4, 2}, 18, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1.5F);
