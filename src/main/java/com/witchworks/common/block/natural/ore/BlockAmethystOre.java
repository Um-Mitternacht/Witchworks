...
public class BlockAmethystOre extends BlockMod {

	public BlockAmethystOre() {
		super(LibBlockName.AMETHYST_ORE, Material.ROCK);
	...
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(Item.getItemFromBlock(ModBlocks.AMETHYST_ORE), 1, this.damageDropped(state));
	}
}
