...
public class BlockHeartGlyph extends BlockMod {

	public static final PropertyEnum<BlockHeartGlyph.EnumAttachPosition> NORTH = PropertyEnum.create("north", BlockHeartGlyph.EnumAttachPosition.class);
	public static final PropertyEnum<BlockHeartGlyph.EnumAttachPosition> EAST = PropertyEnum.create("east", BlockHeartGlyph.EnumAttachPosition.class);
	public static final PropertyEnum<BlockHeartGlyph.EnumAttachPosition> SOUTH = PropertyEnum.create("south", BlockHeartGlyph.EnumAttachPosition.class);
	public static final PropertyEnum<BlockHeartGlyph.EnumAttachPosition> WEST = PropertyEnum.create("west", BlockHeartGlyph.EnumAttachPosition.class);
	...
	public BlockHeartGlyph() {
		super(LibBlockName.SALT_BARRIER, Material.CIRCUITS);
		this.setDefaultState(this.blockState.getBaseState().withProperty(NORTH, BlockHeartGlyph.EnumAttachPosition.NONE).withProperty(EAST, BlockHeartGlyph.EnumAttachPosition.NONE).withProperty(SOUTH, BlockHeartGlyph.EnumAttachPosition.NONE).withProperty(WEST, BlockHeartGlyph.EnumAttachPosition.NONE));
	...
	private static int getAABBIndex(IBlockState state) {
		int i = 0;
		final boolean flag = state.getValue(NORTH) != BlockHeartGlyph.EnumAttachPosition.NONE;
		final boolean flag1 = state.getValue(EAST) != BlockHeartGlyph.EnumAttachPosition.NONE;
		final boolean flag2 = state.getValue(SOUTH) != BlockHeartGlyph.EnumAttachPosition.NONE;
		final boolean flag3 = state.getValue(WEST) != BlockHeartGlyph.EnumAttachPosition.NONE;
	...
	private BlockHeartGlyph.EnumAttachPosition getAttachPosition(IBlockAccess worldIn, BlockPos pos, EnumFacing direction) {
			...
			if (!iblockstate1.isNormalCube()) {
				...
				if (flag && canConnectUpwardsTo(worldIn, blockpos.up())) {
					if (iblockstate.isBlockNormalCube()) {
						return BlockHeartGlyph.EnumAttachPosition.UP;
					}

					return BlockHeartGlyph.EnumAttachPosition.SIDE;
				}
			}

			return BlockHeartGlyph.EnumAttachPosition.NONE;
		} else {
			return BlockHeartGlyph.EnumAttachPosition.SIDE;
		}
	}
