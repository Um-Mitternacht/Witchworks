...
public final class LibBlockName {
	...
	public static final String WITCH_SAPLING = "witch_sapling";
	...
	public static final String CHALK_GLYPH = "chalk_glyph";
	public static final String HEART_GLYPH = "heart_glyph";
