...
public final class LibMod {
	...
	//Dependency
	public static final String DEPENDENCIES = "required-after:Forge@[12.18.3.2234,];required-after:JEI@[3.14.7.414,];required-after:Waila@[1.8.10-B24_1.10.2,];required-after:llibrary@[1.7.2,]";
