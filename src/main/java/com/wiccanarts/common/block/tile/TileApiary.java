...
public class TileApiary extends TileEntityLockable implements ITickable, ISidedInventory {
	...
	public boolean isItemValidForSlot(int index, ItemStack stack) {
		return index == 0 ? stack.getItem() == ModItems.BEE : stack.getItem() == ModItems.HONEYCOMB || stack.getItem() == ModItems.EMPTY_HONEYCOMB;
	}
